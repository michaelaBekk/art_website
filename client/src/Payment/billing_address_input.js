    ...
    return (
        <div>
            <div className="d-flex flex-column payment-section" id="addressContainer">
                ...
                <input type="text" name="second_billing_address" value={this.state.second_billing_address} onChange={this.handleChange} className="payment-input" id="inputAddress2" placeholder="Apartment, studio, or floor" />
            </div>
                <div className="d-flex flex-row payment-section" id="locationContainer">
                    ...
                    <label htmlFor="country" className="payment-label">Country
                        <br />
                        <button type="button" id="selectCountry" className="country-button">{this.state.billing_country}<i className="fa fa-caret-down btn-arrow"></i>
                    ...
                    <label htmlFor="zip_code" className="payment-label">Zip
                        <br />
